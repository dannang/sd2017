...
import Server.Util.Exceptions.ParameterNotFoundException;

public class ParsedUrl {

    /**
     * parameters for which values are to be extracted from the request line,
     * should be defined here as non-static fields prefixed with
     * {@link ParsedUrl#parameterPrefix}
     */
    ...
    /**
     * holds regex patterns for each of the declared parameters (eg.:
     * "(?<=begindate\\=)[\\w\\s-]+(?=(&|$))"
     */
    ...
    static {
        ...
        /**
         * finds the defined parameters. Value parsing will be tried on those
         * parameters alone
         */
     ...
     *
     * @param url (eg.:
     * S1?begindate=xx&enddate=xx&symbol1=xx&extra=xx&exchange=xx)
     * @return a {@link ParsedUrl} instance, representing the parsed URL
     * @throws ParameterNotFoundException if any of the defined parameters
     * cannot be found within the URL
     */
    ...
    private static String[] extractParameterValues(String parametersOnlyUrl) throws ParameterNotFoundException {
        ...
        if (parameterPatterns == null) {
            ...
            /**
             * creates regex patterns for each of the declared parameters (eg.:
             * "(?<=begindate\\=)[\\w\\s-]+(?=(&|$))"
             */
        ...
        int i = 0;
        /**
         * try to extract the value of each parameter from the partial URL (eg.:
         * for parameter 'begindate', value = 'xx' )
         */
     ...
     * @return true, if this and the provided instance have identical underlying
     * values
     */
